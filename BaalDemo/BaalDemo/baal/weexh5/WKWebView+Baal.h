...
#define kBaal_WK_title                 @"title"
#define kBaal_WK_estimatedProgress     @"estimatedProgress"
#define kBaal_WK_URL                   @"URL"
#define kBaal_WK_contentSize           @"contentSize"
 ...
 */
typedef void (^Baal_webView_didStartProvisionalNavigationBlock)(WKWebView * _Nullable webView, WKNavigation *navigation);
...
/**
 ...
 @param navigation navigation
 */
typedef void (^Baal_webView_didCommitNavigationBlock)(WKWebView *webView, WKNavigation *navigation);
...
/**
 ...
 @param navigation navigation
 */
typedef void (^Baal_webView_didFinishNavigationBlock)(WKWebView *webView, WKNavigation *navigation);
...
/**
 ...
 @param navigation navigation
 */
typedef void (^Baal_webView_didFailProvisionalNavigationBlock)(WKWebView *webView, WKNavigation *navigation);
 ...
 */
typedef void (^Baal_webView_isLoadingBlock)(BOOL isLoading, CGFloat progress);
...
/**
 ...
 @param title title
 */
typedef void (^Baal_webView_getTitleBlock)(NSString *title);
 ...
 */
typedef void (^Baal_webView_userContentControllerDidReceiveScriptMessageBlock)(WKUserContentController *userContentController, WKScriptMessage *message);
 ...
 */
typedef void (^Baal_webView_decidePolicyForNavigationActionBlock)(NSURL *currentUrl);
...
/**
 ...
 @param currentUrl currentUrl
 */
typedef void (^Baal_webView_getCurrentUrlBlock)(NSURL *currentUrl);
 ...
 */
typedef void (^Baal_webView_getCurrentHeightBlock)(CGFloat currentHeight);


@interface WKWebView (Baal)
<
...
@property(nonatomic, copy) Baal_webView_didStartProvisionalNavigationBlock ba_web_didStartBlock;
@property(nonatomic, copy) Baal_webView_didCommitNavigationBlock ba_web_didCommitBlock;
@property(nonatomic, copy) Baal_webView_didFinishNavigationBlock ba_web_didFinishBlock;
@property(nonatomic, copy) Baal_webView_didFailProvisionalNavigationBlock ba_web_didFailBlock;
@property(nonatomic, copy) Baal_webView_isLoadingBlock ba_web_isLoadingBlock;
@property(nonatomic, copy) Baal_webView_getTitleBlock ba_web_getTitleBlock;
@property(nonatomic, copy) Baal_webView_userContentControllerDidReceiveScriptMessageBlock ba_web_userContentControllerDidReceiveScriptMessageBlock;
@property(nonatomic, copy) Baal_webView_decidePolicyForNavigationActionBlock ba_web_decidePolicyForNavigationActionBlock;
@property(nonatomic, copy) Baal_webView_getCurrentUrlBlock ba_web_getCurrentUrlBlock;
@property(nonatomic, copy) Baal_webView_getCurrentHeightBlock ba_web_getCurrentHeightBlock;
